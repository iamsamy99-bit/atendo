...
- [x] **consultarDisponibilidad con horarios REALES (10-jul-2026)** — ya no responde texto fijo ni pasa por Make: /api/vapi-webhook intercepta el tool call y consulta Cal.com en vivo (functions/_lib/calcom.ts, event type 6278080, cuenta samuel-garcia-gbsw4p, lun-vie 9-17 Hermosillo). Los CTA de correos ahora apuntan a cal.com/samuel-garcia-gbsw4p/30min (el Calendly quedó obsoleto). CALCOM_API_KEY en .env.local + secret de Pages.
